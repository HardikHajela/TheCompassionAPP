...
.button4:hover {
       ...
       <li class="nav-item dropdown">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
            ...
            <li><hr class="dropdown-divider"></li>
            <li><a class="dropdown-item" href="https://thecompassionapp.myweb.cs.uwindsor.ca/listrt.php"><b>List a Receivers</b></a></li>
          </ul>
        </li>
  ...
  <!-- Table -->
      ...
      $result = $mysqli->query("Select * from trickyrec") or die($mysqli->error);
      $sqlnum=0;
      //pre_r($result);
    ...
    <tr>
      ...
      <th scope="col">Documentation<br> Link</th>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
         	<?php echo $row['city']; ?> <?php echo $row['state']; ?>,<br> <?php echo $row['country']; ?>
	  </td>
      <td>
 		<button class="btn" onclick=" window.open('https://<?php echo $row['med_doc_link']; ?>','_blank')">
 		 	Click Here!
	  	</button>
      </td>
       <td>
  		<a href="#" data-toggle="popover" title="<?php echo $row['notes']; ?>" data-content="">Click<br> Here</a>
      </td>
      <td>
       <?php //echo $num; 
          	//$sqlnum=$num;
