...
.button4:hover {
  ...
  color: white;
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
            ...
            <li><a class="dropdown-item" href="https://thecompassionapp.myweb.cs.uwindsor.ca/regr.php"><b>Become a Receiver</b></a></li>
          </ul>
        </li>
      ...
      <!-------------------------------------------------------------------------------------------------------------------------------->
  <div class = "container">
      <form action="process1.php" method=post oninput='up2.setCustomValidity(up2.value != trickpass.value ? "Passwords do not match." : "")'>
        
  <div class="col-md-4">
    <label for="validationDefault01" class="form-label">Full Name</label>
    <input type="text" class="form-control" id="validationDefault01" name="name" placeholder="Jane Doe" required>
...
<option>	Zimbabwe	</option>
  ...
  <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="niceperson@goodemail.com" name="email" required>
  ...
  <br>
    ...
    <input type="email" name="eml" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
...
-->
  ...
  <div class="col-md-6">
    ...
    <input type="text" name="med_doc_link" class="form-control" id="" value="none">
  ...
  <div id="emailHelp" class="form-text">Anything you'd like to add, here's your chance! You can describe the type, or issue itself. This will give more legitimacy to your case! Please note that the note is limited to 5000 characters.</div>
   </div>
        <br>
